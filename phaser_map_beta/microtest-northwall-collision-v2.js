(() => {
  ...
  const shapes = Object.freeze([
    { id: 'north-wall', type: 'rect', x: 78, y: 0, w: 1128, h: 282, group: 'wall' },
    { id: 'fireplace', type: 'rect', x: 690, y: 246, w: 174, h: 48, group: 'furniture' },
    { id: 'woodpile', type: 'rect', x: 948, y: 210, w: 112, h: 74, group: 'prop' }
  ]);

  const spawn = Object.freeze({ x: 620, y: 540 });
  ...
  if (typeof window !== 'undefined') window.RagbiaMicrotestCollisionV2 = api;
})();
